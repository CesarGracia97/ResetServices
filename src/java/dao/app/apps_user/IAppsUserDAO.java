...
public interface IAppsUserDAO {
 ...
 entity = null;
     ...
     * <pre>
 EntityManagerHelper.beginTransaction();
 entity = IAppsUserDAO.update(entity);
 EntityManagerHelper.commit();
 </pre>
     *
     ...
     */
    public List<AppsUser> findByProperty(String propertyName, Object value
    );

    public List<AppsUser> findByAppsUser(Object schemaName
    );

    public List<AppsUser> findByAppsFullNames(Object OperationName
    );

    public List<AppsUser> findByAppsDescritionUser(Object OperationName
    );
